...
mktempdir() do temp_path
    ...
    for platform in platforms
        ...
        bind_artifact!(artifact_toml, "nodejs_app", product_hash, platform=platform, force=true, download_info=Tuple[("https://github.com/queryverse/NodeJSBuilder/releases/download/v$(URIParser.escape(string(version)))/$archive_filename", download_hash)])
    end
end
